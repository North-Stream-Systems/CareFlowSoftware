    ...
    <section className="bg-offwhite py-24 sm:py-32">
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 className="mt-5 text-balance font-heading text-3xl font-bold text-navy-900 sm:text-4xl">
              Tested against a real care provider, not a demo environment
            </h2>
          </Reveal>
        </div>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-[1.2fr_1fr]">
          ...
          <Reveal delay={0.1}>
            <div className="flex h-full flex-col justify-between rounded-2xl border border-dashed border-navy-200 bg-white p-8">
              <div>
